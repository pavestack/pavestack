...
`,
		...
		filepath.Join(root, "service-template-api", "openapi.yaml"): `openapi: 3.1.0
info:
  title: service-template-api
  description: Golden-path internal API service template for Pavestack (service-template-api).
  version: "0.1.0"
paths:
  /health:
    get:
